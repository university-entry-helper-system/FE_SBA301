  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary-50 to-white">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              <div className="mt-3 text-center text-gray-600">
                Hoặc{' '}
                <Link to="/search" className="text-primary-600 hover:text-primary-700 hover:underline">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-6">THÔNG TIN TUYỂN SINH MỚI NHẤT 2025</h2>
          <p className="text-gray-600 mb-8 max-w-4xl">
            Bộ Giáo dục và Đào tạo mới đây đã công bố danh mục 17 phương thức xét tuyển đại học năm 2025 như: Xét kết quả thi tốt nghiệp THPT, xét kết quả học tập cấp THPT (học bạ), xét kết quả thi đánh giá năng lực, xét kết quả thi đánh giá tư duy...
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
            <h2 className="text-2xl font-bold mb-4">Trường đại học mới công bố đề án tuyển sinh 2025</h2>
            <p className="text-gray-600 mb-6">
              Các trường Đại học đã bắt đầu công bố thông tin tuyển sinh năm 2025. Theo đó phương thức xét tuyển của các trường đa số gồm: xét kết quả thi tốt nghiệp THPT, xét học bạ, xét kết quả thi ĐGNL, xét kết quả thi đánh giá tư duy. Chỉ tiêu tuyển sinh của ngành, tổ hợp xét tuyển của ngành đó vào các trường cũng là thông tin quan trọng giúp các em có những lựa chọn đăng ký xét tuyển vào các trường.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {schools.map((school) => (
                ...
                >
                  ...
                  />
                  <span className="ml-4 text-gray-800 font-medium">{school.name}</span>
                </Link>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  ...
                  <span className="ml-2 text-gray-700 group-hover:text-primary-600">{news}</span>
                </Link>
              ))}
            </div>
          </div>
...
const ExamTypeCard = ({ title, subtitle, description, color, textColor, icon }: ExamTypeCardProps) => (
  <div className={`card p-6 ${color} group hover:scale-[1.02] transition-transform duration-300`}>
